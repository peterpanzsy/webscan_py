...
#            if str(crawler.threadNumber) in self.name:#last thread over
#                glovar.overflag=1
class crawler:
    def __init__(self,threadNumber,firstlink):
